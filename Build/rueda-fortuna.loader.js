...
let progressBarContainer = document.getElementById('progressBarContainer');//Barra de loading Contenedor
let progressBar = document.getElementById('progressBar');//Barra de loading
let loadingScreenBtn = document.getElementById('loadingScreenBtn');

loadingScreenBtn.style.display = 'none';
  ...
  onProgress = onProgress || function () {
    onProgress =  (progress) => {
      ...
      if(progress === 1){
        ...
        portraitAlert.style.zIndex = '2';
        loadingScreen.style.display = 'inline'
        progressBarContainer.style.display = 'none';
        progressBar.style.display = 'none';
        loadingScreenBtn.style.display = 'inline';
      }
    };
